function EventService() {
    return {
        ...
        onApplicationUpdated: function ($scope, callback) { },
        ...
        onFeatureUpdated: function ($scope, callback) { },
        ...
        onFeatureOverrideUpdated: function ($scope, callback) { },
        onConfigurationAdded: function ($scope, callback) { },
        onConfigurationRemoved: function ($scope, callback) { },
        onConfigurationUpdated: function ($scope, callback) { },
